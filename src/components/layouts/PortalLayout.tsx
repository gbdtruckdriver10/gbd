    ...
    switch (effectiveRole) {
      ...
      case "staff":
        return [
          ...
          { path: "/staff/daily-log", label: "Daily Log", icon: ClipboardList },
          { path: "/staff/programs", label: "My Programs", icon: GraduationCap },
      ...
      case "admin":
        return [
          ...
          { path: "/admin/students", label: "Students", icon: UserCheck },
      ...
      case "cfo":
        return [
          ...
          { path: "/finance/messages", label: "Messages", icon: MessageSquare },
        ];
      default:
        return [];
    }
